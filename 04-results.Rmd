...
```{r fac12, echo=FALSE, out.width="75%", fig.align='center', fig.cap="Average Base Index, fac1 and fac2 by Road Type"}
library(here)
...
```{r slopeLTS, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Spatial distribution of slope (a) and Level of Traffic Stress (b) across Greater London."}
library(here)
...
```{r indexs1, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Spatial Distribution of the Index of Structural Ridability"}
library(here)
...
```{r gvi, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Hot and Cold Spot Analysis (Getis-Ord Gi*) of the Green View Index (GVI)"}
library(here)
...
```{r no2, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Spatial Distribution of Annual Mean NO₂ Concentration."}
library(here)
...
### Natural Landscape
```{r nf, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Spatial Distribution of Natural Landscape Coverage."}
library(here)
...
```{r indexs2, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Spatial Distribution of the Index of Environmental Perception"}
library(here)
...
```{r Centrality, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Betweenness and Closeness Centrality in London's Road Network"}
library(here)
...
```{r indexs3, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Spatial Distribution of the Index of Network Centrality."}
library(here)
...
## Cycling Quality Index (CQI) Analysis
...
```{r cqi, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Spatial Distribution of the Cycling Quality Index (CQI) by Quantile"}
library(here)
...
### CQI Kernel Density Estimation in London

```{r kde, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Kernel Density Estimation (KDE) of Low-CQI Road Segments"}
library(here)
...
### The CQI analysis at the borough level
...
```{r AverageCQIbyBorough, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Average Cycling Quality Index (CQI) by London Borough"}
library(here)
...
```{r BoroughComposition, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Borough Road Composition by London-Wide CQI Quantiles"}
library(here)
...
```{r boxcqiborough, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Distribution of CQI Scores within Each London Borough"}
library(here)
...
```{r cqirobustnessdeltabar, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Sensitivity Analysis of Borough Rankings under Alternative Weighting Schemes"}
library(here)
