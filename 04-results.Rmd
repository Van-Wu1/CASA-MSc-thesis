...
### Miscellaneous attributes (`Fac_4`)
...
```{r indexs1, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Spatial Distribution of the Index of Structural Ridability (Higher values indicate better performance)"}
library(here)
knitr::include_graphics(here::here('general_images','index_s1.png'))
```

```{r indexs1histogram, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Histogram of Index of Structural Ridability"}
library(here)
knitr::include_graphics(here::here('general_images','index1histogram.png'))
```
...
```{r indexs2, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Spatial Distribution of the Index of Environmental Perception (Higher values indicate better performance)"}
library(here)
...
```{r indexs3, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Spatial Distribution of the Index of Network Centrality (Higher values indicate better performance)"}
library(here)
...
```{r cqi, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Spatial Distribution of the Cycling Environment Composite Index (CECI) by Quantile (Higher values indicate better performance)"}
library(here)
