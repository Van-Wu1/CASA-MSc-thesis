...
```{r fac12, echo=FALSE, out.width="95%", fig.align='center', fig.cap="Average Base Index, fac1 and fac2 by Road Type"}
library(here)
...
```{r slopeLTS, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Spatial distribution of slope (a) and Level of Traffic Stress (b) across Greater London."}
library(here)
...
```{r no2, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Spatial Distribution of Annual Mean NO₂ Concentration."}
library(here)
...
```{r cqi, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Spatial Distribution of the Cycling Quality Index (CQI) by Quantile"}
library(here)
...
```{r kde, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Kernel Density Estimation (KDE) of Low-CQI Road Segments"}
library(here)
...
```{r AverageCQIbyBorough, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Average Cycling Quality Index (CQI) by London Borough"}
library(here)
...
```{r BoroughComposition, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Borough Road Composition by London-Wide CQI Quantiles"}
library(here)
...
```{r boxcqiborough, echo=FALSE, out.width="100%", fig.align='center', fig.cap="Distribution of CQI Scores within Each London Borough"}
library(here)
