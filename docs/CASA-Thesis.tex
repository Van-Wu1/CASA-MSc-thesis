...
\addcontentsline{toc}{section}{Appendix A Key Parameter Summary}
...
\item
  ...
  \texttt{crs\_metric=\textquotesingle{}EPSG:27700\textquotesingle{}} / \texttt{crs\_output=\textquotesingle{}EPSG:27700\textquotesingle{}}; \texttt{right\_hand\_traffic=True}.
\item
...
\item
  ...
  \texttt{default\_highway\_surface\_dict}, \texttt{default\_cycleway\_surface\_*}, \texttt{default\_track\_surface\_dict} (see Appendix).
\item
...
\section*{Appendix B Research log}\label{appendix-b-research-log}

\section*{Appendix B Research log}\label{appendix-b-research-log-1}
