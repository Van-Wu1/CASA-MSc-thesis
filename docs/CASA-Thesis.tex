...
A foundational metric within this domain is the Level of Traffic Stress (LTS) (\textcite{mekuria_low-stress_2012}), which categorizes road segments by traffic conditions, lane width, speed, and cycling infrastructure presence. Recent developments have extended LTS applicability through open-source mapping platforms, with \textcite{wasserman_evaluating_2019} demonstrating that OpenStreetMap-derived LTS scores achieve 89.9\% accuracy compared to field-validated assessments, facilitating scalable urban mapping applications.
